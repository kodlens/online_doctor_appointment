    ...
    <div>
        ...
        <div class="columns is-centered">
            <div class="column is-8-desktop is-12-tablet">
                ...
                <div style="font-weight: bold; font-size: 1em;">NO. OF NO SHOW IN APPOINTMENT 
                </div>
                ...
                <div>No. of No Show Appointment: {{ countServed }} </div>
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            axios.get(`/get-report-appointment-no-show?${params}`).then(res=>{
                this.data = res.data
            }).catch(err=>{
            })
        },
